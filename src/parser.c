...
static const char * const ts_symbol_names[] = {
  ...
  [sym_text] = "text",
  [sym_eta_script_start_tag] = "start_tag",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_text] = sym_text,
  [sym_eta_script_start_tag] = sym_start_tag,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 76:
      ...
      END_STATE();
    case 77:
      ACCEPT_TOKEN(sym_eta_script_start_tag);
      END_STATE();
    default:
      return false;
  }
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [sym_eta_script_start_tag] = ACTIONS(1),
  ...
  [1] = {
    ...
    [sym_text] = ACTIONS(13),
    [sym_eta_script_start_tag] = ACTIONS(15),
    [sym_comment] = ACTIONS(3),
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(62),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2),
  [62] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(87),
  ...
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(58),
  ...
  [186] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_start_tag_repeat1, 2), SHIFT_REPEAT(63),
  ...
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_start_tag, 3),
  ...
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_start_tag, 4),
